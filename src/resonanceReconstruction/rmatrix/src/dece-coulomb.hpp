#ifndef NJOY_R2_RMATRIX_DECE_COULOMB
#define NJOY_R2_RMATRIX_DECE_COULOMB
...
static const double PI          = 3.14159265358979323846;  /* circular constant     */
static const double EULER       = 0.577215664901532860607; /* Euler-Mascheroni      */
...
/**********************************************************/
void coulombWaveFunctions(const int l, const double rho, const double eta, complex<double> *Coul0, complex<double> *Coul1)
{
  int lmax1 = MAX_L;
  if(l > lmax1) lmax1 = l;
